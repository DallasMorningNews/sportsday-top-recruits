$(document).ready(function() {
  ...
  */
	...
	if (windowWidth > 750) {
				...
				map = L.map('map').setView([32.8935772, -96.8870228],9);
			} else {
				map = L.map('map').setView([32.8935772, -96.8870228],8);
			}
	...
	function drawGraphic() {
		...
		//removing the updated data from the array so as not to blow shit up.
		recruits.shift();
						
		//once our array is in good order sans updated date, we draw the map with the resulting array
		drawMap();
		...
		function drawMap() {
			...
			*/
			...
			map.fitBounds(allRecruits.getBounds())

		}
	}

	$.getJSON("http://interactives.dallasnews.com/data-store/2015/2015-04-hsRecruiting.json", function (data) {
